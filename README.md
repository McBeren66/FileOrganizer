...
To run the script, update the `pfad` variable with the path to the directory you want to tidy and execute the script with Python 3. The script will create the necessary subfolders and move the files accordingly. When it finishes, it prints a summary of how many files were moved. 
